...
//		System.out.println("뚜뚜루");
		
		// Servlet에서 응답 데이터가 있는데?
		// JSP에게 보내줘야함! => request에 담아서 보내줌
						// Servlet 내장 객체 / Scopte 객체
		
		// Application / Session / Request / Page => 저장소로 쓰이는 친구들
		 ...
		 * 계속해서 사용 가능
		 *  
		 * 3. HttpServletRequest (Request Scopte)
		 * 요청 시 매 번 생성되는 객체
		...
		// 문자 담기
		request.setAttribute("str", "테슬라 폭락");
